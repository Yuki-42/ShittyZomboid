...
public class BasicFPCC : MonoBehaviour
{
    ...
    private void ProcessMovement()
    {
        ...
        float nextHeight = Mathf.Lerp( controller.height, h, 5f * Time.deltaTime );  // FIXME: This is causing the player to never complete crouching, as it's always lerping towards the crouch height but never reaching it
